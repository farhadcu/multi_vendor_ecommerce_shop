...
<html class="no-js" lang="zxx">
    <head>
        ...
        <!-- Bootstrap -->
        <link rel="stylesheet" href="{{ asset('public/frontend/css/assets/bootstrap.min.css') }}">

		<!-- Fontawesome Icon -->
        <link rel="stylesheet" href="{{ asset('public/frontend/css/assets/font-awesome.min.css') }}">

		<!-- Animate Css -->
        <link rel="stylesheet" href="{{ asset('public/frontend/css/assets/animate.css') }}">

        <!-- Owl Slider -->
        <link rel="stylesheet" href="{{ asset('public/frontend/css/assets/owl.carousel.min.css') }}">

        <!-- Custom Style -->
        <link rel="stylesheet" href="{{ asset('public/frontend/css/assets/normalize.css') }}">
        <link rel="stylesheet" href="{{ asset('public/frontend/css/style.css') }}">
        <link rel="stylesheet" href="{{ asset('public/frontend/css/assets/responsive.css') }}">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-4">
                        <div class="top-left d-flex">
                            <div class="lang-box">
                                <span><img src="{{ asset('public/frontend/images/fl-eng.png') }}" alt="">English<i class="fa fa-angle-down"></i></span>
                                <ul class="list-unstyled">
                                    <li><img src="{{ asset('public/frontend/images/fl-eng.png') }}" alt="">English</li>
                                    <li><img src="{{ asset('public/frontend/images/fl-fra.png') }}" alt="">French</li>
                                    <li><img src="{{ asset('public/frontend/images/fl-ger.png') }}" alt="">German</li>
                                    <li><img src="{{ asset('public/frontend/images/fl-bra.png') }}" alt="">Brazilian</li>
                                </ul>
                            </div>
                            <div class="mny-box">
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="top-right text-right">
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item"><a href=""><img src="{{ asset('public/frontend/images/user.png') }}" alt="">My Account</a></li>
                                <li class="list-inline-item"><a href=""><img src="{{ asset('public/frontend/images/wishlist.png') }}" alt="">Wishlist</a></li>
                                <li class="list-inline-item"><a href=""><img src="{{ asset('public/frontend/images/checkout.png') }}" alt="">Checkout</a></li>
                                <li class="list-inline-item"><a href=""><img src="{{ asset('public/frontend/images/login.png') }}" alt="">Login</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="cart-body">
            <div class="close-btn">
                <button class="close-cart"><img src="{{ asset('public/frontend/images/close.png') }}" alt="">Close</button>
            </div>
            <div class="crt-bd-box">
                ...
                <div class="cart-content">
                    <div class="content-item d-flex justify-content-between">
                        <div class="cart-img">
                            <a href=""><img src="{{ asset('public/frontend/images/cart1.png') }}" alt=""></a>
                        </div>
                        <div class="cart-disc">
                    ...
                    <div class="content-item d-flex justify-content-between">
                        <div class="cart-img">
                            <a href=""><img src="{{ asset('public/frontend/images/cart2.png') }}" alt=""></a>
                        </div>
                        <div class="cart-disc">
                            <p><a href="">SMART LED TV</a></p>
                            <span>1 x $199.00</span>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3">
                        <div class="sticky-logo">
                            <a href="index.html"><img src="{{ asset('public/frontend/images/logo.png') }}" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="lt-news">
                                                    ...
                                                    <div class="news-box d-flex">
                                                        <div class="news-img">
                                                            <img src="{{ asset('public/frontend/images/mega-img-1.jpg') }}"" alt="">
                                                        </div>
                                                        <div class="news-con">
                                                    ...
                                                    <div class="news-box d-flex">
                                                        <div class="news-img">
                                                            <img src="{{ asset('public/frontend/images/mega-img-2.jpg') }}"" alt="">
                                                        </div>
                                                        <div class="news-con">
                                                            <p>Lorem ipsum dolor sit...</p>
                                                    ...
                                                    <div class="news-box d-flex">
                                                        <div class="news-img">
                                                            <img src="{{ asset('public/frontend/images/mega-img-3.jpg') }}"" alt="">
                                                        </div>
                                                        <div class="news-con">
                                                            <p>Lorem ipsum dolor sit...</p>
                                            ...
                                            <div class="col-md-3">
                                                <div class="m-slider owl-carousel">
                                                    <div class="slider-item">
                                                        <img src="{{ asset('public/frontend/images/mega-1.jpg') }}"" alt="" class="img-fluid">
                                                        <span>-65%</span>
                                                    </div>
                                                    <div class="slider-item">
                                                        <img src="{{ asset('public/frontend/images/mega-2.jpg') }}"" alt="" class="img-fluid">
                                                        <span>-50%</span>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <a href="#" class="bnr-box text-center">
                                                                <img src="{{ asset('public/frontend/images/mega-b-1.jpg') }}"" alt="">
                                                                <span>Camera</span>
                                                            </a>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <a href="#" class="bnr-box text-center">
                                                                <img src="{{ asset('public/frontend/images/mega-b-2.jpg') }}"" alt="">
                                                                <span>Mouse</span>
                                                            </a>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <a href="#" class="bnr-box text-center">
                                                                <img src="{{ asset('public/frontend/images/mega-b-3.jpg') }}"" alt="">
                                                                <span>Earphone</span>
                                                            </a>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <a href="#" class="bnr-box text-center">
                                                                <img src="{{ asset('public/frontend/images/mega-b-4.jpg') }}"" alt="">
                                                                <span>Speaker</span>
                                                            </a>
                                                        </div>
                                                    </div>
                        ...
                        <div class="carts-area d-flex">
                            ...
                            <div class="wsh-box ml-auto">
                                <a href="" data-toggle="tooltip" data-placement="top" title="Wishlist">
                                    <img src="{{ asset('public/frontend/images/heart.png') }}" alt="favorite">
                                    <span>0</span>
                                </a>
                            </div>
        ...
        <!-- jQuery JS -->
        <script src="{{ asset('public/frontend/js/assets/vendor/jquery-1.12.4.min.js') }}"></script>

        <!-- Bootstrap -->
        <script src="{{ asset('public/frontend/js/assets/popper.min.js') }}"></script>
        <script src="{{ asset('public/frontend/js/assets/bootstrap.min.js') }}"></script>

        <!-- Owl Slider -->
        <script src="{{ asset('public/frontend/js/assets/owl.carousel.min.js') }}"></script>

        <!-- Wow Animation -->
        <script src="{{ asset('public/frontend/js/assets/wow.min.js') }}"></script>

        <!-- Price Filter -->
        <script src="{{ asset('public/frontend/js/assets/price-filter.js') }}"></script>

        <!-- Mean Menu -->
        <script src="{{ asset('public/frontend/js/assets/jquery.meanmenu.min.js') }}"></script>
